...
/**
 * Envia lembrete de aula experimental via WhatsApp (3 dias antes, na véspera ou no dia da aula).
 * Extraído dos crons (cron/wpp_lembrete_3dias.php, cron/wpp_lembrete_amanha.php, cron/wpp_lembrete_dia_aula.php)
...
function wppAulaTesteLembrete(array $r, string $tipo): void {
    ...
    if ($tipo === '3dias' || $tipo === '2dias' || $tipo === 'amanha') {
        ...
        $msgResp .= "Lembrando que a aula experimental de *{$nomeAluno}* na *MPG Academy* é {$quando}!\n\n";
